          ...
          <TableRow key={`${item.id}key`}>
            ...
            <TableCell tabIndex={0} role='gridcell'>
              <TableCellLayout>
                ...
                <span style={{ verticalAlign: 'middle', paddingLeft: '2px', paddingRight: '8px' }}>{formatNumber(item.succeeded)}</span>
                ...
                <span style={{ verticalAlign: 'middle', paddingLeft: '2px', paddingRight: '8px' }}>{formatNumber(item.failed)}</span>
                {item.canceled && (
                  <>
                    ...
                    <span style={{ verticalAlign: 'middle', paddingLeft: '2px', paddingRight: '8px' }}>{formatNumber(item.canceled)}</span>
                  </>
                )}
                {item.unknown && (
                  <>
                    ...
                    <span style={{ verticalAlign: 'middle', paddingLeft: '2px', paddingRight: '8px' }}>{formatNumber(item.unknown)}</span>
                  </>
                )}
              </TableCellLayout>
            </TableCell>
